...
export let db = {
    ...
    summaries: [
        { date: '2025-10-01', content: 'Studied advanced SQL JOINs and subqueries.' },
        { date: '2025-09-30', content: 'Revised concepts of Normalization in DBMS.' },
        { date: '2025-09-29', content: 'Practiced Python loops and conditional statements.' },
        { date: '2025-09-28', content: 'Learned about the basics of semiconductor physics.' },
        { date: '2025-09-27', content: 'Completed the first chapter of Linear Algebra.' },
        { date: '2025-09-26', content: 'Reviewed notes on Engineering Graphics and projections.' },
        { date: '2025-09-25', content: 'Worked on civil engineering basics, including types of beams.' },
    ]
};
